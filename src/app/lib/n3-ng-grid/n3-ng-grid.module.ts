...
import { ColumnRefDirective } from './columns/column-ref.directive';
...
@NgModule({
  ...
  declarations: [ColumnsComponent, Column1RefDirective, Column2RefDirective, Column3RefDirective, GridComponent, HeaderComponent, NeckComponent, FooterComponent, ColumnRefDirective],
